...
export const LIVE_RECOVERY_PREPARE_CONFIRMATION = 'VERIFICA ACQUISTI E PREPARA RIPRESA';
export const LIVE_RECOVERY_EXECUTE_CONFIRMATION = 'COMPLETA PIANO';
export const LIVE_RECOVERY_FORCE_CONFIRMATION = 'TUTTO OK FORZA LIVE';
